(function () {
  ...
  var applyDefaults = function applyDefaults(initialOptions) {
    ...
    return _objectSpread({}, defaultOptions, initialOptions);
  };
  /**
  ...
  */
  ...
  var getCallbackURL = function getCallbackURL() {
    ...
    var options = _objectSpread({}, defaultOptions, initialOptions);
  ...
  */
  ...
  var wwpassQRCodeAuth = function wwpassQRCodeAuth(initialOptions) {
    ...
    options.qrcodeStyle = _objectSpread({}, defaultOptions.qrcodeStyle, initialOptions.qrcodeStyle);
    var log = options.log;
  ...
  var wwpassPluginExecute = function wwpassPluginExecute(inputRequest) {
    return new Promise(function (resolve, reject) {
      ...
      var request = _objectSpread({}, defaultOptions, inputRequest);
  ...
  var wwpassAuth = function wwpassAuth(request) {
    return wwpassCall(wwpassNMExecute, wwpassPluginExecute, _objectSpread({}, request, {
      operation: 'auth'
    }));
  };
