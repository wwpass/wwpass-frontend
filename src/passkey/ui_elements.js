...
<p><a href="https://chrome.wwpass.com/?callbackURL=${returnURL}">Install WWPass Authentication Extension</a>`;
...
const passkeyButtonHTML = `\
<svg id="icon-button_logo" viewBox="0 0 34 20" style="fill: none; left: 28px; stroke-width: 2px; width: 35px; height: 25px; top: 5px; position: absolute;">
